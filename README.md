# Analyzing-and-Resolving-a-Suspicious-Login-As-a-SOC-L2
Conducting a deeper analysis to determine whether the event indicated compromised credentials or legitimate activity, identified related indicators of compromise, documented the investigation and containment actions, and resolved the alert after confirming the threat was mitigated.
![Image alt](https://github.com/Kevinolee1/Analyzing-and-Resolving-a-Suspicious-Login-As-a-SOC-L2/blob/79684a7083fc8bf3484376ef51a635e37c7ead84/Screenshot%202026-08-18%20011200.png)
Log in to your SOC Level 2 analyst account.
...
Access the Suspicious Login ticket to review the alert details, investigation history, and supporting evidence.
...
Update the ticket status to Closed, then select Post Note to document the final resolution.
